...
public class UserInfoChangeCompleteDAO extends ActionSupport {
	...
	private String sql2 = "UPDATE destination_info SET user_address = ?, user_address2 = ?, user_address3 = ?, tel_number = ?, tel_number2 = ?, tel_number3 = ? "
			...
			/*
			 * 	↑のsqlで行をWHEREで指定するために、userIDを使いたいからやっぱりユーザーＩＤも
			 * セッションに格納しておく   午後に修正する
			 */
	/////////////////////////////////////////////////////////////

	public void infoChange(String userId,String password,String familyName,String firstName,
			String familyNameKana,String firstNameKana,int sex,String email,int question,String answer,
			String userAddress,String userAddress2,String userAddress3,String telNumber,String telNumber2,String telNumber3) throws SQLException{
